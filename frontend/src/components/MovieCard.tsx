  ...
  return (
    <div className="max-w-2xl w-full">
      ...
      <div className="relative w-full h-auto md:h-96">
        {/* Mobile Layout - Show either front or back based on flip state */}
          ...
          {!isFlipped ? (
            ...
            >
              <div className="bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-700">
                <div className="flex flex-col items-center">
                  {/* Poster Container with fixed height for Safari compatibility */}
                  <div className="relative w-full max-w-[300px] bg-gray-700 p-4">
                    <div className="relative w-full" style={{ paddingBottom: '150%' }}> {/* 2:3 aspect ratio */}
                      ...
                      />
                      {/* Score Badge */}
                      <div className="absolute top-3 right-3 bg-black bg-opacity-80 rounded-md px-2 py-1 z-10">
                        <span className={`font-bold text-xs ${getScoreColor(movie.score)}`}>
                          {movie.score.toFixed(1)}
                        </span>
                      </div>
                      {/* Tap to flip indicator */}
                      <div className="absolute bottom-3 left-3 bg-black bg-opacity-60 rounded-md px-2 py-1 z-10">
            ...
            >
              <div className="bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-700 w-full max-w-[300px] mx-auto">
                ...
                <div className="p-4 flex flex-col" style={{ minHeight: '450px' }}>
                  {/* Header */}
